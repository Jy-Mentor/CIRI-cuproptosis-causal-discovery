...
output_file = "D:/EQTL/mr_results_p1e-05_fixed/outcome_filtered_15genes.csv"
chr_pos_file = "D:/EQTL/mr_results_p1e-05_fixed/exposure_chr_pos_list.txt"
...
print(f"  示例: {list(chr_pos_list)[:5]}")
