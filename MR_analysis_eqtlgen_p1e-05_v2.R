...
output_dir    <- "D:/EQTL/mr_results_p1e-05_megastroke"
dir.create(output_dir, showWarnings = FALSE, recursive = TRUE)

cat("========== eQTLGen p=1e-05 MR 分析（MEGASTROKE结局） ==========\n")
...
exposure_data <- as.data.frame(exposure_data)  # 转换为data.frame
