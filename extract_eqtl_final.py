...
# 处理脑组织数据
brain_stats = process_csv_file(BRAIN_CSV, brain_genes, "Brain_Cortex", OUTPUT_DIR)
print(f"  ✓ 脑皮层：处理 {brain_stats['processed']:,} 行，保存 {brain_stats['saved']:,} 基因\n")

# 处理全血数据
blood_stats = process_csv_file(BLOOD_CSV, blood_genes, "Whole_Blood", OUTPUT_DIR)
