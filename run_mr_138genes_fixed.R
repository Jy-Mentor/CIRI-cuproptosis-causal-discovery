#!/usr/bin/env Rscript
# ================================================================================
# 138 基因 MR 分析（修复版 - 直接使用格式化的 eQTLGen 数据）
# ================================================================================
...
for (i in seq_along(target_genes)) {
  ...
  # MEGASTROKE 没有 hm_pval 列，使用 p_value
