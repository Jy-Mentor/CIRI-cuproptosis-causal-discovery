#!/usr/bin/env Rscript
# MR分析脚本 - 40个基因, eQTLGen p=1e-05, MEGASTROKE结局
...
output_dir    <- "D:/EQTL/mr_results_40genes_p1e-05"
dir.create(output_dir, showWarnings = FALSE, recursive = TRUE)

cat("========== 40基因 MR分析 (p=1e-05, MEGASTROKE) ==========\n")
...
# 检查每个基因的SNP数
gene_counts <- table(exposure_snps$gene_name)
cat("\n各基因SNP数:\n")
print(gene_counts)
cat("\n")
